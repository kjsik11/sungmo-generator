...
import qrKakaoImage from '/public/images/created-by-img.kay-480x480-low.webp';
import nerdsLabImage from '/public/images/nerds-lab.png';
...
export default function Footer({ className }: Props) {
  ...
  return (
    <>
      <footer className={cn(className, 'py-16 bg-gray-50 px-4')}>
